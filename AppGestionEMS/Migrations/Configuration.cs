namespace AppGestionEMS.Migrations
{
	...
	internal sealed class Configuration : DbMigrationsConfiguration<AppGestionEMS.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(AppGestionEMS.Models.ApplicationDbContext context)
        {
            ...
            AddUser(context, "ficitio1", "apell", "ficticio1@alumnos.upm.es", roleAlumno);
            AddUser(context, "ficitio2", "apell", "ficticio2@alumnos.upm.es", roleAlumno);
            AddUser(context, "ficitio3", "apell", "ficticio3@alumnos.upm.es", roleAlumno);
        }
